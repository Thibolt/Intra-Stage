            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="./professors-dashboard.php"><span class="glyphicon glyphicon-tasks"> Panel</a></li>
                        <li><a href="./professors-dashboard-account-settings.php"><span class="glyphicon glyphicon-wrench"></span> Compte</a></li>
